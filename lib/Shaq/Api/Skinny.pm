...
sub new {
    ...
    croak('Please set $config->{master}->{db_class}')
      unless $config->{master}->{db_class};
    croak('Please set $config->{master}->{connect_info}')
      unless $config->{master}->{connect_info};
    croak('Please set $config->{slave}->{db_class}')
      unless $config->{slave}->{db_class};
    croak('Please set $config->{slave}->{connect_info}')
